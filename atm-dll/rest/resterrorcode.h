...
enum errors:uint {
    ERR_UNKNOWN = REST_CREATE_ERR_CODE(ERR_GENERIC, 1),
        ...
        ERR_UNKNOWN_ACCOUNT = REST_CREATE_ERR_CODE(ERR_VALUE, 12),
        ERR_NEW_PIN_INVALID = REST_CREATE_ERR_CODE(ERR_VALUE,13),
        ERR_SAME_PIN = REST_CREATE_ERR_CODE(ERR_VALUE,14)
