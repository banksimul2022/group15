...
public:
    enum ReturnType : int {
        typeLogin,typeLogout,typeInfo,typeProfile,typeTransaction,typeLatestTransaction,typeWithdraw,typeDeposit,typeTransfer,typeBalance,typeinternalerror //login =0 / logout 1 jne...
    };
